...
describe('Polsky', function () {
    ...
    describe('printing with reduce flag set', function () {
        it('should print the formatted and reduced expression in human readable format', function () {
            ...
            assert.deepEqual(new polsky.Parser('a * a * b * c * c * c * d').print(true), '(* b d (^ a 2) (^ c 3))');
            ...
            assert.deepEqual(new polsky.Parser('a * a * ( b * b / c ) * ( d / e )').print(true), '(/ (* d (^ a 2) (^ b 2)) (* c e))');
            assert.deepEqual(new polsky.Parser('6 + 6 + ( ( 7 + 7 + 7 ) / 9 ) * ( 2 / 3 )').print(true), '(+ 12 (/ 14 9))');
